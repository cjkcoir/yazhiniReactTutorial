function Navbar() {
  return (
    <>
      ...
      <nav className="navbar navbar-light bg-warning mt-5">
      ...
      <nav className="navbar navbar-expand-lg navbar-light text-white bg-success mt-5">
  <div className="container-fluid">
    <a className="navbar-brand text-white  fw-bold" href="#">CJK ENTERPRISES</a>
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav mx-auto">
        <li className="nav-item  ">
          <a className="nav-link active text-warning fs-2" aria-current="page" href="#">Home</a>
        </li>
        <li className="nav-item">
...
<div className="container mt-5">
    ...
    <div className="border border-2 border-danger w-25 p-5 mx-auto">
        Hello
    </div>
